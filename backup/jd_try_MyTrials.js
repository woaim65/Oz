...
[task_local]
#京东试用待领取通知
1 8 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_try_MyTrials.js, tag=京东试用待领取通知, enabled=true

================Loon==============
[Script]
cron "1 8 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_try_MyTrials.js,tag=京东试用待领取通知

===============Surge=================
京东试用待领取通知 = type=cron,cronexp="1 8 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_try_MyTrials.js

============小火箭=========
京东试用待领取通知 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_try_MyTrials.js, cronexpr="1 8 * * *", timeout=3600, enable=true
